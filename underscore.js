...
// const myEmployeesAddress = myEmployees.map(e => e.address);
// console.log(myEmployeesAddress);
...
// const myEmployeesAges = myEmployees.map(e => e.age);
...
// Bonus Points
const totalByMonth = 0; // Use the groupdd purchasesByMonth and reduce to create a totalByMonth object.
...
let getJedi = _.memoize(function (n) {
  return axios.get(`https://swapi.co/api/people/${n}` + n);
